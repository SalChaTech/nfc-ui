...
<!--      &lt;!&ndash; Google login butonu &ndash;&gt;-->
<!--      <div class="form-actions" style="justify-content: center;">-->
<!--        <button type="button" @click="loginWithGoogle" class="btn-primary">-->
...
<!--// Google OAuth login başlat-->
<!--const loginWithGoogle = () => {-->
<!--  // Backend endpointi Google OAuth URL'ine yönlendiriyor-->
<!--  window.location.href = 'http://localhost:8080/auth/google'-->
<!--}-->

<!--// Kullanıcıyı kontrol et ve login olmuşsa upload sayfasına yönlendir-->
<!--const checkUser = async () => {-->
<!--  try {-->
<!--    const res = await axios.get('http://localhost:8080/auth/me', { withCredentials: true })-->
<!--    if (res.data) {-->
<!--      user.value = res.data-->
<!--      router.push('/upload') // Login başarılı ise upload sayfasına yönlendir-->
<!--    }-->
<!--  } catch (err) {-->
...
<!--<style scoped>-->
<!--/* Mevcut login-container ve login-card CSS’inizi buraya bırakabilirsiniz */-->
<!--.login-container {-->
<!--  min-height: 100vh;-->
<!--  display: flex;-->
